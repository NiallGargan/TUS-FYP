...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void MyInput()
    {
        ...
        // when to double jump
        if (Input.GetKey(KeyCode.LeftAlt) && readyToDoubleJump && !grounded)
        {
    ...
    {
        //to check if the player is touching a wall
        wallRight = Physics.Raycast(transform.position, orientation.right, out rightWallHit, wallCheckDistance, whatIsWall);
        wallLeft = Physics.Raycast(transform.position, -orientation.right, out leftWallHit, wallCheckDistance, whatIsWall);
    }

    //start wall run when off ground and beside wall
    ...
    private void WallRunning()
    {
        ...
        //to wall run both directions on walls
    ...
    private void WallJump()
    {
        ...
        Vector3 forceApply = transform.up * wallJumpSideForce + wallNormal * wallJumpSideForce;
    ...
    //end wall run after conditions met
